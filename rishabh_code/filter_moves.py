...
if __name__ == '__main__':
    ...
    DATA_FILE = join(PARENT_DIR,
            'test/expert/{} Championship Player_best_moves.p'.format(player))
    NEW_DATA_FILE = join(PARENT_DIR,
            'test/expert/Filtered_championship_moves.p')
