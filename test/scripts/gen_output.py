...
if __name__ == '__main__':
    ...
    parser.add_argument("-w", "--weights", nargs=num_w, required=True)
    ...
    if args.outfile is None:
        outfile = os.path.join(DIR_NAME, "out/out_w_" + "_".join(fn_weights) + '_'+ \
            args.player1 + '_' + args.player2)
    else:
    ...
    command = "./test --mode=selfplay --lexicon=csw12" + \
            ...
            seed_arg + " -z {}".format(num_w) + " --weights \"|" + "|".join(fn_weights) + '"'
    if use_parallel:
